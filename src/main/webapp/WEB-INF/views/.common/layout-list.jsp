...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Open+Sans&family=Overlock+SC&display=swap" rel="stylesheet">
    ...
    <link rel="stylesheet" href="<c:url value='/static/css/headbar-elements.css' />">
...
<div class="app-container">
    <header class="app-header">
        <div class="header-left">
            ...
            <span class="logo-name">Flarista</span>
        </div>
    ...
    <nav class="app-sidebar">
        <ul>
            ...
            <li><strong>Quản Lý Phòng</strong><i class="fa-solid fa-bars" id="menu-toggle"></i></li>
            ...
            <li><a href="<c:url value='/thietbiphong' />">Thiết Bị Phòng</a></li>
            <hr>
